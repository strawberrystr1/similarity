    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" size="sm">
          ...
          <Icons.Moon className="absolute rotate-0 scale-0 transition-all hover:text-slate-900 hover:rotate-0 dark:scale-100 dark:text-slate-400 dark:hover:text-slate-100" />
